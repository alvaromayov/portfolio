    ...
    render() {
        return (
            <div className="unveil">
                <svg id="logo" width="647" height="480" viewBox="0 0 647 480" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        <filter id="filter0_d" x="73.5" y="446.5" width="206" height="33" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
